...
Param(
    [string] $ArtifactStagingDirectory = ".\templates",
    [string] [alias("ResourceGroupLocation")] $Location = "eastus",
    [string] $ResourceGroupName = "rg-hub",
    [switch] $UploadArtifacts = $true,
    [string] $StorageAccountName,
    [string] $StorageContainerName = $ResourceGroupName.ToLowerInvariant() + '-stageartifacts',
    [string] $TemplateFile = $ArtifactStagingDirectory + '\main.json',
    [string] $TemplateParametersFile = $ArtifactStagingDirectory + '.\main.parameters.json',
